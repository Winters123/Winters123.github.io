...
2. Xuyan Jiang, Wenwen Fu, **Xiangrui Yang\***, Yingwen Chen, Wenfei Wu, Zhigang Sun. "Megabits Down to Kilobits: Memory-Efficient Time-Aware Shaping for TSN." *ACM/IEEE DAC* (CCF-A), 2025. **(Corresponding Author)**

3. Yuanhang Gao, Yingwen Chen, **Xiangrui Yang\***, Huan Zhou, Shihua Tang, Ming Xu. "Magneto: Load-Balanced Key-Value Service for Write-Intensive Workloads." *IEEE Transactions on Services Computing* (CCF-A), 2025, 18(5): 2994-3007. **(Corresponding Author)**

4. Xuetan Cheng, Yingwen Chen, **Xiangrui Yang\***, Huan Zhou, Lailong Luo, Deke Guo. "Memory-Efficient Programmable Packet Parsing for Multi-Tenant Terabit Networks." *Computer Networks* (CCF-B), 2025, 264: 111240. **(Corresponding Author)**
...
1. **Xiangrui Yang**, et al. "Network Traffic Conditional Branch Logic Processing Method." CN119172309B, 2025.
2. **Xiangrui Yang**, et al. "Action Execution Engine Supporting RMT and Its Execution Method." CN116156027B, 2023.
3. **Xiangrui Yang**, et al. "Control Path Communication Control Method and Device Supporting RMT." CN116155731B, 2023.
